...
public class UsuarioServicio {
    // DefiniciÛn del tipo de algoritmo a utilizar (AES, DES, RSA)
    private final static String alg = "AES";
    // DefiniciÛn del modo de cifrado a utilizar
    ...
    public String agregarUsuario() throws Exception{
        ...
        String iv = "0123456789ABCDEF"; // vector de inicializaciÛn
        String respuesta = "";
        ...
        if(contrasenia.length() >= 8){
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error!", "La contrase√±a de contener al menos 8 caracteres"));
        }
        return respuesta;   
    }
